...
# description: 用于生成专家数据并预训练导师（Tutor）模型的独立脚本。
...
def main():
    ...
    else: # Fallback for models without extract_features
    ...
    # --- 6. 预训练导师模型的 Actor ---
    tutor_model.pretrain_actor(expert_loader, epochs=10) # 预训练10个epoch
