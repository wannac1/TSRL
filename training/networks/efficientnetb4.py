...
class EfficientNetB4(nn.Module):
    def __init__(self, efficientnetb4_config):
        ...
        if efficientnetb4_config['pretrained']:
            local_weights_path = "./training/pretrained/efficientnet-b4-6ed6700e.pth"
            self.efficientnet = EfficientNet.from_pretrained('efficientnet-b4', weights_path=local_weights_path)
