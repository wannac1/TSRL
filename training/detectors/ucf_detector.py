...
class UCFDetector(AbstractDetector):
    ...
    def forward(self, data_dict: dict, inference=False, calc_reconstruction=True) -> dict:
        ...
        if calc_reconstruction:
            ...
            reconstruction_imgs = None # 跳过昂贵的 GAN 计算
        # --- ▲▲▲ 【【【修改结束】】】 ▲▲▲
        ...
        pred_dict = {
            ...
            'recontruction_imgs': reconstruction_imgs # 返回 None 或图像元组
        }
        return pred_dict
