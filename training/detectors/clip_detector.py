...
class CLIPDetector(AbstractDetector):
    ...
    def build_backbone(self, config):
        ...
        _, backbone = get_clip_visual(model_name="/project/leizhanhe/deepfake/DeepfakeBench/clip-vit-base-patch16")
        return backbone
...
def get_clip_visual(model_name = "F:/deepfake/DeepfakeBench/clip-vit-base-patch16"):
